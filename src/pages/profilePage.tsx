    ...
    return (
        ...
        <div className="welcome-markeet-opner clearfix" id="home">
            <div className="chain-container">
                <div className="markeet-profile-header">
                </div>
                ...
                <div className="row">
                    <div className="col-md-3">
                        <div className="profile-outer-holder">
                            ...
                            <span>0xb89c2f6bb674b...5b15 <a href="#"><img src="assets/images/copy.png" alt=""/> </a> </span>
                    ...
                    <div className="col-md-9">
                        <div className="tab_container">
                            ...
                            <label><span>On Sale</span></label>

                            <input id="tab2" type="radio" name="tabs"/>
                            <label><i className="fa fa-pencil-square-o"></i><span>Collections</span></label>

                            <input id="tab3" type="radio" name="tabs"/>
                            <label><i className="fa fa-pencil-square-o"></i><span>Creations</span></label>

                            <input id="tab4" type="radio" name="tabs"/>
                            <label><i className="fa fa-pencil-square-o"></i><span>Likes</span></label>
